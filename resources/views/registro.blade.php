...
<div class="w-full max-w-md bg-white sm:rounded-3xl shadow-none sm:shadow-xl overflow-hidden border-0 sm:border border-gray-100 p-6 sm:p-8 relative">
    ...
    <div class="w-full">
        ...
        <p class="text-gray-500 mb-8 text-sm">Tomará menos de un minuto.</p>
        ...
        <form action="{{ url('/registro') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="password" name="password" placeholder="••••••••" class="w-full pl-12 pr-4 py-3.5 bg-gray-50 sm:bg-white rounded-2xl border border-gray-200 outline-none focus:border-[#105B3A] focus:ring-2 focus:ring-[#105B3A]/20 text-base transition placeholder:text-gray-400" required>
                </div>
            </div>
