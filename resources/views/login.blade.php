    ...
    <form action="{{ url('/login') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative flex items-center">
                ...
                <input type="password" id="login_password" name="password" placeholder="••••••••" class="w-full pl-12 pr-12 py-3.5 bg-gray-50 sm:bg-white rounded-2xl border border-gray-200 outline-none focus:border-[#FFBC00] focus:ring-2 focus:ring-[#FFBC00]/20 text-base transition" required>
                <!-- Botón del Ojo -->
                <button type="button" onclick="togglePassword('login_password', 'eye-icon-login')" class="absolute right-4 text-[#98A2B3] hover:text-[#105B3A] transition">
                    <svg id="eye-icon-login" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                </button>
            </div>
        </div>
